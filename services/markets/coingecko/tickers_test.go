...
func TestProvider_GetTickers(t *testing.T) {
	...
	provider := InitProvider(server.URL, "USD", assets.NewClient("assets.api"))
...
func Test_createTicker(t *testing.T) {
	...
	for i, price := range prices {
		ticker := createTicker(price, watchmarket.Token, unknownCoinID, "shitcoin", "shitcoinID", "coingecko", "USD")
